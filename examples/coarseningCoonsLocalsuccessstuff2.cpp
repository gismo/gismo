...
//    std::string xmlFile = "/home/turing/theydarov/xmlFiles/resultLocalsuccessstuff2";
    std::string badFile = "/home/turing/theydarov/xmlFiles/badgeoLocalsuccessstuff2";
    std::string pvdFile = "/home/turing/theydarov/pvdFiles/resultLocalsuccessstuff2";
    ...
    real_t epsilon_g = 1e+6, epsilon_f = 5.6e-3;
...
//    givenGeo+="upperhalf";
    ...
    //    givenGeo = "thb_map";
    std::string fileLoc = "/home/turing/theydarov/txtFiles/resultLocalsuccessstuff2";
...
//                    return 0;
                        ...
                        real_t uniformity = 0;//1e+12;//e-12;//1e-2;//1e-3;//1e-17;//17;//1e-17;//5e+13;//1e-8;
                        real_t area = 0;//1e-8;//11;//1e-18;//1e+15;//1e+16;//1e-8;//0.00001;
                        real_t length = 1;//1e+6;//1e+3;//1e-18;//1e+18;//8;//1e+13;//1e+17;//1e+18;//0.000002;
                        real_t epsilon = 1e-7;
                        int jacPts = 101 * 101;
                        bool dumped = false;
