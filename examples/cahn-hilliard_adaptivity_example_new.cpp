            ...
            std::string out)
{
    ...
    auto     c  = cold  + af * ( cnew -  cold);
    auto     dc = dcold + am * (dcnew - dcold);
    auto  gradc = igrad(cold,G) + af * (igrad(cnew,G) - igrad(cold,G));
    auto  laplc = ilapl(cold,G) + af * (ilapl(cnew,G) - ilapl(cold,G));
