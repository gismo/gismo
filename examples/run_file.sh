...
TAGS=(
    ...
    #"-r 2 -u 2 -f  0.  -l 3 -a 0.7 -c 1 -p 0 -e 0"
    #"-r 2 -u 4 -f  12. -l 0 -a 0.0 -c 0 -p 0 -e 0"
    #"-r 2 -u 4 -f  12. -l 0 -a 0.5 -c 1 -p 3  -e 0"
    #"-r 2 -u 4 -f  12. -l 2 -a 0.7 -c 2 -p 3 -e 0"
    # 3 dimensions case
    #"-r 2 -u 1 -f  0.  -l 3 -a 0.0 -c 0 -p 0 -e 0 -i 1"
    #"-r 2 -u 1 -f  0.  -l 3 -a 0.5 -c 0 -p 3 -e 0 -i 1"
    #"-r 2 -u 1 -f  0.  -l 3 -a 0.7 -c 1 -p 0 -e 0 -i 1"
    #"-r 2 -u 1 -f  12. -l 3 -a 0.0 -c 0 -p 0 -e 0"
    "-r 2 -u 1 -f  12. -l 0 -a 0.5 -c 1 -p 3  -e 0"
    #"-r 2 -u 1 -f  12. -l 3 -a 0.7 -c 2 -p 3 -e 0"
    #.. Advection diffusion ...
