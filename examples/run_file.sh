...
TAGS=(
    ...
    #.. Advection diffusion ...
    "-r 2 -u 4  -f  12. -l 2 -a 0.7 -c 1 -e 1"
    # "-r 2 -u 3  -f   0. -l 2 -a 0.7 -c 1 -e 1"
    # .. Elasticity 2D ...
    #"-r 2 -u 2 -f  0.  -l 6 -a 0.0 -c 0 -e 0"
    #"-r 2 -u 2 -f  0.  -l 6 -a 0.7 -c 0 -e 0"
    #"-r 2 -u 2 -f  12. -l 3 -a 0.0 -c 0 -e 0"
    #"-r 2 -u 2 -f  12. -l 6 -a 0.7 -c 1 -e 0"
)
