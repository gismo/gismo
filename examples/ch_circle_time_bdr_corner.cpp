            ...
            std::string out)
{
    ...
    // circle translation
    gsFunctionExpr<> sourceQold("-((61440000000000000000000*tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22) + 61440000000000000000000)*(tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22) - 1)*(y^4*((159*x^2)/512 + 2237710077071038113/1441151880758558720) - y^3*((159*x^2)/128 + 2983570802018245083/1441151880758558720) + y^2*((159*x^4)/512 + (1342619651131152033*x^2)/720575940379279360 + 4475260272721462407/2882303761517117440) - y*((159*x^4)/256 + (447529225191265889*x^2)/360287970189639680 + 3580105884765341677/5764607523034234880) + (3580105884765341677*x^2)/11529215046068469760 + (447529225191265889*x^4)/1441151880758558720 + (53*x^6)/512 - (159*y^5)/256 + (53*y^6)/512 - tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)*((2*y^4*((237*x^2)/3200 + 426943777499153441/1152921504606846976))/3 - (2*y^3*((237*x^2)/800 + 2846325620986762387/5764607523034234880))/3 - (2*y*((237*x^4)/1600 + (683126254075000297*x^2)/2305843009213693952 + 683146518111307429/4611686018427387904))/3 + (2*y^2*((237*x^4)/3200 + (1280836398146321163*x^2)/2882303761517117440 + 2134782209007067949/5764607523034234880))/3 + (683146518111307429*x^2)/13835058055282163712 + (683126254075000297*x^4)/13835058055282163712 + (79*x^6)/4800 - (79*y^5)/800 + (79*y^6)/4800 + 569305652990362427/34587645138205409280) + (3863477044307799*sin((2*pi*t)/3)*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)^3*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2))/18889465931478580854784 - tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)^2*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)*((25*y^2*((159*x^2)/3200 + 6874340371905727557/46116860184273879040))/2 - (25*y*((159*x^2)/1600 + 1790216711791805098343/18014398509481984000000))/2 + (1790216711791805098343*x^2)/2882303761517117440000 + (159*x^4)/512 - (159*y^3)/128 + (159*y^4)/512 + 14322020573612689889113/46116860184273879040000) + tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)^3*((79*x^2)/3200 + (79*y^2)/3200 - (79*y)/1600 + 2277019683368146627/92233720368547758080)*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)*(x^2 + y^2 - 2*y + 1) + 149165748061068293/1441151880758558720))/((100000*x^2 + 100000*y^2 - 200000*y + 100001)^3*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2))",2);
    gsFunctionExpr<> sourceQnew("-((61440000000000000000000*tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22) + 61440000000000000000000)*(tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22) - 1)*(y^4*((159*x^2)/512 + 2237710077071038113/1441151880758558720) - y^3*((159*x^2)/128 + 2983570802018245083/1441151880758558720) + y^2*((159*x^4)/512 + (1342619651131152033*x^2)/720575940379279360 + 4475260272721462407/2882303761517117440) - y*((159*x^4)/256 + (447529225191265889*x^2)/360287970189639680 + 3580105884765341677/5764607523034234880) + (3580105884765341677*x^2)/11529215046068469760 + (447529225191265889*x^4)/1441151880758558720 + (53*x^6)/512 - (159*y^5)/256 + (53*y^6)/512 - tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)*((2*y^4*((237*x^2)/3200 + 426943777499153441/1152921504606846976))/3 - (2*y^3*((237*x^2)/800 + 2846325620986762387/5764607523034234880))/3 - (2*y*((237*x^4)/1600 + (683126254075000297*x^2)/2305843009213693952 + 683146518111307429/4611686018427387904))/3 + (2*y^2*((237*x^4)/3200 + (1280836398146321163*x^2)/2882303761517117440 + 2134782209007067949/5764607523034234880))/3 + (683146518111307429*x^2)/13835058055282163712 + (683126254075000297*x^4)/13835058055282163712 + (79*x^6)/4800 - (79*y^5)/800 + (79*y^6)/4800 + 569305652990362427/34587645138205409280) + (3863477044307799*sin((2*pi*t)/3)*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)^3*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2))/18889465931478580854784 - tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)^2*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)*((25*y^2*((159*x^2)/3200 + 6874340371905727557/46116860184273879040))/2 - (25*y*((159*x^2)/1600 + 1790216711791805098343/18014398509481984000000))/2 + (1790216711791805098343*x^2)/2882303761517117440000 + (159*x^4)/512 - (159*y^3)/128 + (159*y^4)/512 + 14322020573612689889113/46116860184273879040000) + tanh(6*cos((2*pi*t)/3) + (1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)/25 - 22)^3*((79*x^2)/3200 + (79*y^2)/3200 - (79*y)/1600 + 2277019683368146627/92233720368547758080)*(x^2 + y^2 - 2*y + 2251822331683385/2251799813685248)*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2)*(x^2 + y^2 - 2*y + 1) + 149165748061068293/1441151880758558720))/((100000*x^2 + 100000*y^2 - 200000*y + 100001)^3*(1000000*x^2 + 1000000*y^2 - 2000000*y + 1000010)^(1/2))",2);
    ...
    gsFunctionExpr<> bc1("(4*x*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (40*x*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(1/2) - (3200*x^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1)^2)/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (3*x^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(5/2) + (320*x*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000) - (800*x*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1)^2)/((y - 1)^2 + x^2 + 1/100000)^(3/2) + (120*x*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(1/2) - (240*x^3*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^2 - (3*x*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/(4*((y - 1)^2 + x^2 + 1/100000)^(5/2)) - (6400*x^3*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (1600*x*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (60*x*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^2","(2*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (20*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(1/2) - (3*(2*y - 2)^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/(8*((y - 1)^2 + x^2 + 1/100000)^(5/2)) - (400*(2*y - 2)^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1)^2)/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (1600*x^2*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1)^2)/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (30*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(2*y - 2)^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^2 + (60*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(1/2) - (800*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(2*y - 2)^3*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (3*x^2*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/(2*((y - 1)^2 + x^2 + 1/100000)^(5/2)) + (160*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000) - (3200*x^2*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (120*x^2*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(2*y - 2)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^2",2);

    // (2) Laplace boundary condition
    gsFunctionExpr<> bc2("(80*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(1/2) - (10*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (40*x^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)^(3/2) - (800*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(2*y - 2)^2*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000) - (3200*x^2*tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)*(tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)^2 - 1))/((y - 1)^2 + x^2 + 1/100000)",2);
    // =====================================================
...
#   else
    ...
    else
    {
        ...
        gsFunctionExpr<> initial_cond("-tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)",2);
    ...
    gsFunctionExpr<> source_time("-tanh(6*cos((2*pi*t)/3) + 40*((y - 1)^2 + x^2 + 1/100000)^(1/2) - 22)",2);
