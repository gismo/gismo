...
//    gsFunctionExpr<> solVal("(16/3 - x/3 - y) * (16 - 3*x - y) * (5 - x) * (x - 7 - y) * (x/3 - 5 - y) * (-5 - x/2 - y) * (-19 - 4*x - y) * (11 + 2*x - y) * (7 + x - y) * (5 - y)",3);
//
//    gsFunctionExpr<>sol1der ("1/18 *(y - 5) *(216 *x^8 + 16 *x^7 *(y - 253) - 7* x^6 *(293 *y^2 + 370 *y + 4089) + 6 *x^5 *(23 *y^3 + 440 *y^2 + 11251 *y + 109390) \n"
...
//                             "1/18 *(x - 5) *(24 *x^8 + 4 *x^7 *(y - 99) + x^6 *(-879 *y^2 + 2210 *y - 4219) + 4 *x^5 *(23 *y^3 - 855 *y^2 + 7288 *y + 8010) \n"
...
//                             "(y * (1 - x^2 + y^2) ) / (1 + x^2 + y^2)^2", 3);
    ...
    std::string string_geo_planar = "KirchhoffLoveGeo/geo_threePatches.xml";
