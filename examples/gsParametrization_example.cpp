/** @file gsParametrization_example.cpp

    @brief Provides implementation of the gsParametrization class.
...
int main(int argc, char **argv)
{
    ...
    std::string filenameOut("result.xml");
    ...
    gsCmdLine cmd("Param Command line");
