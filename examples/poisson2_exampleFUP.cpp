...
int main(int argc, char *argv[])
{
    ...
    mp=gsNurbsCreator<>::BSplineSquareGrid(1,1,2.5);
    ...
    //chagnes for Fup basis functions
    ...
    A.setOptions(Aopt);
    A.options().setInt("quB", 3);// increase accuracy
