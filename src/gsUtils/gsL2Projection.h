...
public:
    ...
    static void system( const gsMultiBasis<T>   & projectionBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _system(projectionBasis, projectionBasis, geometryMap, geometryMap, systemMatrix, rhs, options);
    }
    ...
    static void system( const gsMultiBasis<T>   & integrationBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _system(integrationBasis, projectionBasis, geometryMap, geometryMap, systemMatrix, rhs, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        gsMultiBasis<T> basis(projectionBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _system(basis, basis, geometry, geometry, systemMatrix, rhs, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        ...
        gsMultiBasis<T> intbasis(integrationBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _system(intbasis, basis, geometry, geometry, systemMatrix, rhs, options);
    }
    ...
    static void system( const gsMultiBasis<T>   & projectionBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _system(projectionBasis, projectionBasis, geometryMap, sourceFunction, systemMatrix, rhs, options);
    }
    ...
    static void system( const gsFunctionSet<T>  & projectionBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _system(integrationBasis, projectionBasis, geometryMap, sourceFunction, systemMatrix, rhs, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        gsMultiBasis<T> basis(projectionBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _system(basis, basis, geometry, sourceFunction, systemMatrix, rhs, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        ...
        gsMultiBasis<T> intbasis(integrationBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _system(intbasis, basis, geometry, sourceFunction, systemMatrix, rhs, options);
    }
    ...
    static void matrix( const gsMultiBasis<T>   & projectionBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _matrix(projectionBasis, projectionBasis, geometryMap, systemMatrix, targetDim, options);
    }
    ...
    static void matrix( const gsMultiBasis<T>   & integrationBasis,
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        _matrix(integrationBasis, projectionBasis, geometryMap, systemMatrix, targetDim, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        gsMultiBasis<T> basis(projectionBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _matrix(basis, basis, geometry, systemMatrix, targetDim, options);
    }
                        ...
                        const gsOptionList      & options = gsOptionList())
    {
        ...
        gsMultiBasis<T> intbasis(integrationBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _matrix(intbasis, basis, geometry, systemMatrix, targetDim, options);
    }
    ...
    static void rhs(const gsMultiBasis<T>   & projectionBasis,
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        _rhs(projectionBasis, projectionBasis, geometryMap, geometryMap, rhs, options);
    }
    ...
    static void rhs(const gsMultiBasis<T>   & integrationBasis,
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        _rhs(integrationBasis, projectionBasis, geometryMap, geometryMap, rhs, options);
    }
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        gsMultiBasis<T> basis(projectionBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _rhs(basis, basis, geometry, geometry, rhs, options);
    }
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        ...
        gsMultiBasis<T> intbasis(integrationBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _rhs(intbasis, basis, geometry, geometry, rhs, options);
    }
    ...
    static void rhs(const gsMultiBasis<T>   & projectionBasis,
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        _rhs(projectionBasis, projectionBasis, geometryMap, sourceFunction, rhs, options);
    }
    ...
    static void rhs(const gsFunctionSet<T>  & projectionBasis,
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        _rhs(integrationBasis, projectionBasis, geometryMap, sourceFunction, rhs, options);
    }
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        gsMultiBasis<T> basis(projectionBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _rhs(basis, basis, geometry, sourceFunction, rhs, options);
    }
                    ...
                    const gsOptionList      & options = gsOptionList())
    {
        ...
        gsMultiBasis<T> intbasis(integrationBasis);
        gsMultiPatch<T> geometry(geometryMap);
        _rhs(intbasis, basis, geometry, sourceFunction, rhs, options);
    }
    ...
    /**
     * @brief Initializes the Python wrapper for the class: gsL2Projection
     */
    void pybind11_init_gsL2Projection(pybind11::module &m);
