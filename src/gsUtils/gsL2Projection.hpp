...
template<typename T>
void gsL2Projection<T>::_matrix(const gsMultiBasis<T>  & integrationBasis,
...
template<typename T>
void gsL2Projection<T>::_rhs(const gsMultiBasis<T>  & integrationBasis,
                                const gsFunctionSet<T> & projectionBasis,
                                const gsFunctionSet<T> & geometryMap,
...
template<typename T>
void gsL2Projection<T>::_system(const gsMultiBasis<T>  & integrationBasis,
                                const gsFunctionSet<T> & projectionBasis,
                                const gsFunctionSet<T> & geometryMap,
                                const gsFunctionSet<T> & sourceFunction,
                                      gsSparseMatrix<T>& systemMatrix,
