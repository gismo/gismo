 ...
 *
 *  The matrices \f$ S_k \f$ are stored in a vector accesible via \a localSchurOp . As usual,
 *  they are stored in form of a vector of \a gsLinearOperator s. These operators represent
 *  the Schur-complements of the matrices \f$ A_k \f$ with respect to the degrees of freedom
 *  on the skeleton.
 *
 *  The jump matrices \f$ \hat B_k \f$ are accessible via \a jumpMatrix . These matrices usually
 *  differ from the matrices \f$ \tilde B_k \f$ from the IETI-system since -- for the preconditioner --
 ...
 *
 *  The scaling matrices \f$ D_k \f$ are stored in a vector accessible via \a scalingMatrix. They
 *  can be provided by the caller or generated by calling \a setupMultiplicityScaling .
 *
 *  @ingroup Solver
**/
