...
/**
 * @brief Divergence of \a u with respect to the parametric domain
 * @param u The variable
 */
GISMO_SHORTCUT_VAR_EXPRESSION(  div, jac(u).trace() )

/**
 * @brief Divergence of \a u with respect to the physical domain
 * @param u The variable
...
/**
 * @brief The normalized normal vector on the boundary
 * @param G The geometry map
 */
GISMO_SHORTCUT_MAP_EXPRESSION(unv, nv(G).normalized()   )

/**
 * @brief The normalized surface normal vector
 * @param G The geometry map
 */
GISMO_SHORTCUT_MAP_EXPRESSION(usn, sn(G).normalized()   )

/**
 * @brief Gradient of \a u with respect to the parametric domain
 * @param u The variable
 */
GISMO_SHORTCUT_VAR_EXPRESSION(igrad, grad(u) ) // u is presumed to be defined over G

/**
 * @brief Gradient of \a u with respect to the physical domain
 * @param u The variable
 * @param G The geometry map
 */
...
/**
 * @brief Jacobian of \a u with respect to the physical domain
 * @param u The variable
 * @param G The geometry map
 */
...
/**
 * @brief Hessian of \a u with respect to the parametric domain
 * @param u The variable
 */
GISMO_SHORTCUT_VAR_EXPRESSION(ihess, hess(u) )

/**
 * @brief Hessian of \a u with respect to the physical domain
 * @param u The variable
 * @param G The geometry map
