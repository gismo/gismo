 ...
 */
    ...
    template <class T>
    class gsVisitorG1Biharmonic
    {
    public:

        gsVisitorG1Biharmonic(const gsPde<T> & pde)
        {
         ...
         */
        gsVisitorG1Biharmonic(const gsFunction<T> & rhs) :
                rhs_ptr(&rhs)
        {
                             ...
                             gsMatrix<T>            & quNodes)
        {
            ...
            basis.evalAllDers_into(patchIndex, md.points, 2, basisData);
