/** @file gsKirchhoffLoveShellAssembler.h
...
#include <gsPde/gsKirchhoffLoveShellPde.h>
...
/** @brief
    Implementation of a homogeneous Kirchoff-Love Shell Assembler.
    ...
    not implemented).
*/
template <class T, class bhVisitor = gsVisitorKirchhoffLoveShell<T> >
class gsKirchhoffLoveShellAssembler : public gsAssembler<T>
{
public:
...
/** @brief
    ...
    \param[in] rhs is the right-hand side of the Kirchhoff-Love equation, \f$\mathbf{f}\f$.
...
*/
    gsKirchhoffLoveShellAssembler( gsMultiPatch<T> const         & patches,
...
protected:
    ...
    gsKirchhoffLoveShellPde<T> m_ppde;
...
void gsKirchhoffLoveShellAssembler<T,bhVisitor>::refresh()
{
...
template <class T, class bhVisitor>
void gsKirchhoffLoveShellAssembler<T,bhVisitor>::assemble()
{
