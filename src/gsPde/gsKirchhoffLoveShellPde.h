/** @file gsKirchhoffLoveShellPde.h
...
/** @brief
    A Kirchhoff-Love PDE.

    This class describes a Kirchoff-Love PDE, with an arbitrary right-hand side
    function.
...
template<class T>
class gsKirchhoffLoveShellPde : public gsPde<T>
{
protected:
    gsKirchhoffLoveShellPde( ) { }
...
public:
    ...
    {
        os<<"Kirchhoff-Love's equation  -\u0394^2 u = f ,  with:\n";
