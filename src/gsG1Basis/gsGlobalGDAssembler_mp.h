...
#include <gsG1Basis/gsVisitorGlobalGD_mp.h>
#include <gsCore/gsMultiPatch.h>

namespace gismo
{

template <class T, class bhVisitor = gsVisitorGlobalGD_mp<T> >
class gsGlobalGDAssembler_mp : public gsAssembler<T>
{
public:
    typedef gsAssembler<T> Base;

public:
    gsGlobalGDAssembler_mp(gsBasis<T> const & basis,
...
void gsGlobalGDAssembler_mp<T, bhVisitor>::refresh()
{
...
template <class T, class bhVisitor>
void gsGlobalGDAssembler_mp<T, bhVisitor>::assemble()
{
...
template <class T, class bhVisitor>
inline void gsGlobalGDAssembler_mp<T, bhVisitor>::apply(bhVisitor & visitor,
                                                     int patchIndex,
                                                     boxSide side)
{
#pragma omp parallel
...
#endif
    {
        ...
        visitor_.evaluate(basis, quNodes, m_mp, m_iFace, m_gamma);
