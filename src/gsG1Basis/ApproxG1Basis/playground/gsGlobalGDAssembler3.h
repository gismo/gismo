...
#include <gsG1Basis/gsVisitorGlobalApproxGD3.h>
#include <gsAssembler/gsAssembler.h>

namespace gismo
{

template <class T, class bhVisitor = gsVisitorGlobalApproxGD3<T> >
class gsGlobalGDAssembler3 : public gsAssembler<T>
{
public:
    typedef gsAssembler<T> Base;

public:
    gsGlobalGDAssembler3(gsMultiPatch<T> const & mp,
...
void gsGlobalGDAssembler3<T, bhVisitor>::refresh()
{
...
template <class T, class bhVisitor>
void gsGlobalGDAssembler3<T, bhVisitor>::assemble()
{
...
template <class T, class bhVisitor>
inline void gsGlobalGDAssembler3<T, bhVisitor>::apply(bhVisitor & visitor)
{
#pragma omp parallel
    {
        bhVisitor
