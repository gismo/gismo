...
#define __DEF0(type, name, void)            public:  inline typename type::uPtr name() const { return uPtr(name##_impl()); }
#define __DEF1(type, name, t1)              public:  inline typename type::uPtr name(t1 n1) const { return uPtr(name##_impl(n1)); }
#define __DEF2(type, name, t1, t2)          public:  inline typename type::uPtr name(t1 n1, t2 n2) const { return uPtr(name##_impl(n1, n2)); }
