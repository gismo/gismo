...
template<std::size_t nbits, std::size_t es> inline bool isfinite(sw::unum::posit<nbits,es> a) {return true; }
template<std::size_t nbits, std::size_t es> inline bool isinf(sw::unum::posit<nbits,es> a)    {return false;}
template<std::size_t nbits, std::size_t es> inline bool isnan(sw::unum::posit<nbits,es> a)    {return false;}
