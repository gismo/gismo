...
void pybind11_init_gsBSpline(py::module &m)
{
  ...
  py::class_<Class>(m, "gsBSpline")
    ...
    .def("coefs", (gsMatrix<real_t>& (Class::*)())&Class::coefs, "Returns the coeffcient matrix (as a reference)") //there are 2 versions of coefs()
    ...
    .def("insertKnot", &Class::insertKnot, "Insert the given new knot with multiplicity without changing the curve")
    .def("degreeElevate", &Class::degreeElevate, "Elevates the degree by the given amount without changing the curve")
