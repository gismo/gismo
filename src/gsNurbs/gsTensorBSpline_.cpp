...
CLASS_TEMPLATE_INST gsTensorBSpline<1,real_t, gsKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<2,real_t, gsKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<3,real_t, gsKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<4,real_t, gsKnotVector<real_t> >;

CLASS_TEMPLATE_INST gsTensorBSpline<1,real_t, gsCompactKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<2,real_t, gsCompactKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<3,real_t, gsCompactKnotVector<real_t> >;
CLASS_TEMPLATE_INST gsTensorBSpline<4,real_t, gsCompactKnotVector<real_t> >;
