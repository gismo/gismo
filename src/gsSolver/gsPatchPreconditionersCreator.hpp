...
{
    dirichlet::strategy ds = (dirichlet::strategy)opt.askInt("DirichletStrategy",dirichlet::elimination);
    GISMO_ENSURE (ds == dirichlet::elimination, "gsPatchPreconditionersCreator<>::removeCornersFromInverse: Unknown Dirichlet strategy.");
    GISMO_ENSURE (gamma == 0, "gsPatchPreconditionersCreator<>::removeCornersFromInverse: Gamma is not allowed to be non zero.");
