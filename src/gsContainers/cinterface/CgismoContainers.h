/** @file CgismoContainers.h

    @brief C interface umbrella of the gsContainers module (multi-patch geometries and bases).

    Include only what you use: this header exposes the C API of gsContainers
