/** @file gsKdTree.h
    ...
    @brief Provides declaration of the KdTree class.
...
#include <gsHSplines/gsKdNode2.h>

namespace gismo 
{

template<typename T, unsigned d>
class gsKdTreeIterator;
...
{
public:
    typedef gsKdNode<d, Z, leafNode> node;

    typedef gsVector<index_t,d> point;

    typedef typename node::kdBox box; // it's a gsAABB<d,unsigned>

    typedef gsKdTreeLeafIter<node,false> literator;

    typedef gsKdTreeLeafIter<node,true> const_literator;

    template <class U, unsigned dd> friend class gsKdTreeIterator;
...
public:
    ...
    gsKdTree() : m_root(nullptr)
    { }

    gsKdTree(node const & nd)
    {
        m_root = nullptr;
        init(nd);
    }
    ...
    gsKdTree( const gsKdTree & o) : m_root(new node(*o.m_root));
    { }
    ...
    ~gsKdTree() { delete m_root; }

    /// Clones the object
    gsKdTree * clone() const;
...
public:
    ...
    /// Accessor for gsKdTree::m_upperIndex
    ...
    * unique knot indices of gsKdTree::m_maxInsLevel
    *
...
private:
    ...
    /// All indexing is in terms of level gsKdTree::m_maxInsLevel. \n
    // getBoxes-functions might get removed at some point of time.
    // Use iterators instead whenever possible.
    ...
    /// are defined by the knot indices on level gsKdTree::m_maxInsLevel.
...
private:
    ...
    struct maxLevel_visitor
    {
        ...
        static void visitLeaf(gsKdNode2<d, Z> * leafNode, return_type &i)
        {
    ...
    struct levelUp_visitor
    {
        ...
        static void visitLeaf(gsKdNode2<d, Z> * leafNode, return_type &)
        {
            leafNode->level++;
        }
    };
    ...
    struct numLeaves_visitor
    {
        ...
        static void visitLeaf(gsKdNode2<d, Z> * , return_type & i)
        {
            i++;
        }
    };
    ...
    struct numNodes_visitor
    {
        ...
        static void visitNode(gsKdNode2<d, Z> * , return_type & i)
        {
            i++;
        }
    };
    ...
    struct liftCoordsOneLevel_visitor
    {
        ...
        static void visitNode(gsKdNode2<d, Z> * leafNode, return_type &)
        {
    ...
    struct get_cell_visitor
    {
        ...
        static void visitLeaf(gismo::gsKdNode2<d, Z> * leafNode , int level, return_type & res)
        {
...
#include GISMO_HPP_HEADER(gsKdTree.hpp)
#endif
