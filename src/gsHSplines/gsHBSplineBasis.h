...
// class gsDeprecated : public gsHTensorBasis<d,T>
// {
// public:
...
//     typedef typename 
//     util::conditional<d==1, gsConstantBasis<T>, gsDeprecated<static_cast<short_t>(d-1),T>
//                       >::type BoundaryBasisType;

//     /// @brief Shared pointer for gsDeprecated
//     typedef memory::shared_ptr< gsDeprecated > Ptr;

//     /// @brief Unique pointer for gsDeprecated
//     typedef memory::unique_ptr< gsDeprecated > uPtr;
...
//     gsDeprecated(gsBasis<T> const&  tbasis, bool manualLevels=false )
//         : gsHTensorBasis<d,T>(tbasis, manualLevels) 
//     {
//         // initialize(); // is done in the base constructor
//     }
    
//     gsDeprecated( gsTensorBSplineBasis<d,T> const&  tbasis,
...
//     GISMO_CLONE_FUNCTION(gsDeprecated)
...
//   /**
//    * @brief Initializes the Python wrapper for the class: gsDeprecated
//    */
