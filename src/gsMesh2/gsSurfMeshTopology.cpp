/** @file gsSurfMeshTopology.cpp
    ...
    @brief Implementation of the surface-specific part of gsSurfMeshTopology:
    the Euler operators and the surface queries.  Everything dimension-agnostic
    lives in gsMeshTopology.
