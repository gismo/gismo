...
macro(OFA_HandleArmOptions)
  ...
  elseif(NOT TARGET_ARCHITECTURE STREQUAL "none")
    ...
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a14" OR TARGET_ARCHITECTURE STREQUAL "apple-m1")
      ...
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "fp" "fp16" "lse" "simd" "ras" "rcpc" "rdm" "sha2" "zcm" "zcz")
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a15" OR TARGET_ARCHITECTURE STREQUAL "apple-m2")
      list(APPEND _mtune_flag_list "vortex")
      list(APPEND _march_flag_list "armv8.5-a")
      list(APPEND _march_flag_list "armv8.4-a")
      list(APPEND _march_flag_list "armv8.3-a")
      ...
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "fp" "fp16" "lse" "simd" "ras" "rcpc" "rdm" "sha2" "zcm" "zcz")
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a16" OR TARGET_ARCHITECTURE STREQUAL "apple-m3")
      list(APPEND _mtune_flag_list "vortex")
      list(APPEND _march_flag_list "armv8.5-a")
      list(APPEND _march_flag_list "armv8.4-a")
      list(APPEND _march_flag_list "armv8.3-a")
    ...
    if(NOT _ok)
      ...
      file(READ ${CMAKE_MODULE_PATH}/ChecksArm.txt _checks)
