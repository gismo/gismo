...
macro(OFA_HandleArmOptions)
  ...
  elseif(NOT TARGET_ARCHITECTURE STREQUAL "none")
    ...
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a7")
      ...
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crypto" "fp" "neon" "sha2" "zcm" "zcz")
    ...
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a10")
      ...
      list(APPEND _march_flag_list "armv8.1-a")
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "fp" "neon" "rdm" "sha2" "zcm" "zcz")
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a11")
      list(APPEND _mtune_flag_list "apple-a11")
      list(APPEND _march_flag_list "armv8.2-a")
      list(APPEND _march_flag_list "armv8.1-a")
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "fp" "lse" "neon" "ras" "rdm" "sha2" "zcm" "zcz")
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a12")
      ...
      list(APPEND _march_flag_list "armv8.1-a")
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "fp" "fp16" "lse" "neon" "ras" "rcpc" "rdm" "sha2" "zcm" "zcz")
    elseif(TARGET_ARCHITECTURE STREQUAL "apple-a13")
      ...
      list(APPEND _march_flag_list "armv8.1-a")
      list(APPEND _march_flag_list "armv8-a")
      list(APPEND _available_extension_list "aes" "crc" "crypto" "dotprod" "fp" "fp16" "fp16fml" "lse" "neon" "ras" "rcpc" "rdm" "sha2" "sha3" "sm4" "zcm" "zcz")
    ...
    if(NOT _ok)
      ...
      foreach (_check ${_checks})
        ...
        string(REPLACE ";" "+" _check_flags "${_check_extension_flags}")
        ...
        if(${_useVar})
          ...
          message(${_code})
          message("${_march_flag}${_march}+${_extension_flag}")
      ...
      foreach(_extension_flag ${_check_extension_flag_list})
        ...
        if(${_useVar})
          ...
          list(APPEND _enable_extension_list "${_extension_flag}")
        endif()
      endforeach()
      ...
      if(MSVC AND MSVC_VERSION GREATER 1900)
        _ofa_find(_enable_extension_list "vfpv4" _found)
        if(_found)
          AddCompilerFlag("/arch:VFPv4" CXX_FLAGS OFA_ARCHITECTURE_FLAGS CXX_RESULT _found)
        endif()
        if(NOT _found)
          _ofa_find(_enable_extension_list "simd" _found)
          if(_found)
