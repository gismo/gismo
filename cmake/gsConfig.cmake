...
IF((CMAKE_SYSTEM_NAME STREQUAL "Darwin") AND (CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang"))
  ...
  # CMake 3.1 complains it does not know how to set the compile flag
  # to enable C++11 with (Apple) Clang
  SET(CMAKE_CXX11_STANDARD_COMPILE_OPTION "-std=c++11")
  SET(CMAKE_CXX11_EXTENSION_COMPILE_OPTION "-std=gnu++11")
ELSEIF((CMAKE_SYSTEM_NAME STREQUAL "Windows") AND MSVC)
  # CMake 3.1 complains it does not know how to set the compile flag
  # to enable C++11 with MSVC
...
if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 6.1)
  if(CMAKE_CXX_STANDARD EQUAL "14")
    ...
    if(COMPILER_SUPPORTS_CXX14)
      ...
      message(FATAL_ERROR "The compiler ${CMAKE_CXX_COMPILER} has no C++14 support, use CMAKE_CXX_STANDARD=11 or 98.")
    endif()
  endif()
  ...
  if(CMAKE_CXX_STANDARD EQUAL "11")
      ...
      if(COMPILER_SUPPORTS_CXX11)
        ...
        if(COMPILER_SUPPORTS_CXX0X)
          ...
          message(FATAL_ERROR "The compiler ${CMAKE_CXX_COMPILER} has no C++11 support, use CMAKE_CXX_STANDARD=98.")
        endif()
     endif()
   endif()
else() #gcc 6.1
