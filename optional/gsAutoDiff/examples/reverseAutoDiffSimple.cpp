/** @file reverseAutoDiffSimple.cpp

    @brief Simple example demonstrating reverse-mode automatic differentiation with autodiff::var

    Shows what currently works with GISMO and var types.
...
int main()
{
    ...
    std::cout << "  - Element-wise operations on matrix data" << std::endl;
    std::cout << "  - Optimization with many parameters" << std::endl;
    std::cout << "  - Custom objective functions" << std::endl;
    std::cout << "  - Gradient computation in O(1) passes (vs O(n) for forward-mode)" << std::endl;
    
    std::cout << "\n! Current limitations:" << std::endl;
    std::cout << "  - Direct gs Matrix<var> operations limited (namespace issues)" << std::endl;
    std::cout << "  - Use element-wise access for matrix operations" << std::endl;
    std::cout << "  - Advanced linear algebra may have compatibility issues" << std::endl;
    
    std::cout << "\n→ Recommended use cases for var:" << std::endl;
    ...
    std::cout << "  1. Spatial derivatives (df/dx, df/dy)" << std::endl;
    std::cout << "  2. Few parameters, many outputs" << std::endl;
    std::cout << "  3. Full GISMO matrix integration" << std::endl;
