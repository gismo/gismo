...
template< typename ExprType_v2 >                       Expr_atan2_Real_Real< ConstantReal, ExprType_v2 > atan2(const double&                        v1, const RealExpression< ExprType_v2 >& v2);
template< typename ExprType_v1 >                       Expr_atan2_Real_Real< ExprType_v1, ConstantReal > atan2(const RealExpression< ExprType_v1 >& v1, const double&                        v2);
...
template< typename ExprType_v2 >                       Expr_max_Real_Real< ConstantReal, ExprType_v2 >   max(const double&                        v1, const RealExpression< ExprType_v2 >& v2);
template< typename ExprType_v1 >                       Expr_max_Real_Real< ExprType_v1, ConstantReal >   max(const RealExpression< ExprType_v1 >& v1, const double&                        v2);
...
template< typename ExprType_v2 >                       Expr_min_Real_Real< ConstantReal, ExprType_v2 >   min(const double&                        v1, const RealExpression< ExprType_v2 >& v2);
template< typename ExprType_v1 >                       Expr_min_Real_Real< ExprType_v1, ConstantReal >   min(const RealExpression< ExprType_v1 >& v1, const double&                        v2);
...
template< typename ExprType_v2 >                       Expr_pow_Real_Real< ConstantReal, ExprType_v2 >   pow(const double&                        v1, const RealExpression< ExprType_v2 >& v2);
template< typename ExprType_v1 >                       Expr_pow_Real_Real< ExprType_v1, ConstantReal >   pow(const RealExpression< ExprType_v1 >& v1, const double&                        v2);
