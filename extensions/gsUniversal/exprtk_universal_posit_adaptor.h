...
template <typename T> inline T   abs_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::abs  (v); }
template <typename T> inline T  acos_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::acos (v); }
template <typename T> inline T acosh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::acosh(v); }
template <typename T> inline T  asin_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::asin (v); }
template <typename T> inline T asinh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::asinh(v); }
template <typename T> inline T  atan_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::atan (v); }
template <typename T> inline T atanh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::atanh(v); }
template <typename T> inline T  ceil_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::ceil (v); }
template <typename T> inline T   cos_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::cos  (v); }
template <typename T> inline T  cosh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::cosh (v); }
template <typename T> inline T   exp_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::exp  (v); }
template <typename T> inline T floor_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::floor(v); }
template <typename T> inline T   log_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::log  (v); }
template <typename T> inline T log10_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::log10(v); }
template <typename T> inline T  log2_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::log2 (v); }
...
template <typename T> inline T   sin_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::sin  (v); }
template <typename T> inline T  sinh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::sinh (v); }
template <typename T> inline T  sqrt_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::sqrt (v); }
template <typename T> inline T   tan_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::tan  (v); }
template <typename T> inline T  tanh_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::tanh (v); }
template <typename T> inline T   cot_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::cot  (v); }
template <typename T> inline T   sec_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::sec  (v); }
template <typename T> inline T   csc_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::csc  (v); }
...
template <typename T> inline T  frac_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::frac (v); }
template <typename T> inline T trunc_impl(const T& v, UNUM_TYPE_TAG) { return sw::universal::trunc(v); }
