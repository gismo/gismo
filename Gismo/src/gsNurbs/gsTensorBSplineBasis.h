...
#include <gsUtils/gsTensorTools.h>
...
public:
  ...
  gsTensorBSplineBasis( const KnotVectorType& KV1, const KnotVectorType& KV2, const KnotVectorType& KV3 )
...
public:
  ...
  */
  ...
  // TODO: Write somewhere that omitting "this->" leads to "'m_bases' was not declared in this scope."
      ...
      for( int i = 0; i < this->dim(); i++ )
      {
          if( this->component(i).isPeriodic() )
          {
              if( m_isPeriodic == -1 )
                  ...
                  gsWarn << "Don't know how to handle a basis that is periodic in more than one direction.\n";
          }
      }
  }
