...
#include <gsCore/gsTensorDomainIterator.h>
#include <gsCore/gsTensorDomainBoundaryIterator.h>
...
//////////////////////////////////////////////////
    ...
    {
        return typename gsBasis<T>::domainIter(new 
                                               gsTensorDomainBoundaryIterator<T,1>(*this, s));
    }
