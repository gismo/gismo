...
# include <cstdint>
#else
# define intmax_t  std::size_t
# define uintmax_t std::size_t
#endif
#include <complex>
#include <algorithm>
...
public:
    ...
    template <typename real_type> mpreal& operator= (const std::complex<real_type>& z);
...
inline mpreal& mpreal::operator= (const std::complex<real_type>& z)
{
    return *this = z.real();
}
...
{
    mpreal y(0, mpfr_get_prec(x.mpfr_srcptr())); 
#ifndef _MPFR_NO_DEPRECATED_ROOT
...
{
    mpreal x;
#ifndef _MPFR_NO_DEPRECATED_GRANDOM
