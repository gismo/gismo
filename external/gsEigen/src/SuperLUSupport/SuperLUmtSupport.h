...
#define DECL_GSSVX(PREFIX,FLOATTYPE,KEYTYPE)		\
    extern "C" {                                                                                          \
      extern void PREFIX##gssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,                  \
                                ...
                                GlobalLU_t *, superlu_memusage_t *, SuperLUStat_t *, int *);                     \
    }                                                                                                     \
...
#define DECL_GSSVX(PREFIX,FLOATTYPE,KEYTYPE)		\
    extern "C" {                                                                                          \
        extern void PREFIX##gssvx(int, superlumt_options_t *, SuperMatrix *, int *, int *, int *, \
                                char *, FLOATTYPE *, FLOATTYPE *, SuperMatrix *, SuperMatrix *,           \
                                /*void *, int,*/ SuperMatrix *, SuperMatrix *, \
                                FLOATTYPE *, FLOATTYPE *, FLOATTYPE *, FLOATTYPE *,                       \
                                superlu_memusage_t *, Gstat_t *, int *);                                   \
    }                                                                                                     \
    inline float SuperLU_gssvx(int nprocs, superlumt_options_t *options, SuperMatrix *A, \
         int *perm_c, int *perm_r, int *etree, char *equed,                                               \
         FLOATTYPE *R, FLOATTYPE *C, SuperMatrix *L,                                                      \
         SuperMatrix *U, void *work, int lwork,                                                           \
         SuperMatrix *B, SuperMatrix *X,                                                                  \
         FLOATTYPE *recip_pivot_growth,                                                                   \
         FLOATTYPE *rcond, FLOATTYPE *ferr, FLOATTYPE *berr,                                              \
         Gstat_t *stats, int *info, KEYTYPE) {                                                      \
    superlu_memusage_t mem_usage;                                                                                \
    PREFIX##gssvx(nprocs,options, A, perm_c, perm_r, etree, equed, R, C, L, \
         U, /*work, lwork,*/ B, X, recip_pivot_growth, rcond,  \
...
class SuperLUBase : public SparseSolverBase<Derived>
{
  ...
  public:
    ...
    inline superlumt_options_t& options() { return m_sluOptions; }
  ...
  protected:
    ...
    mutable Gstat_t m_sluStat;
    mutable superlumt_options_t m_sluOptions;
    mutable std::vector<int> m_sluEtree;
    mutable Matrix<RealScalar,Dynamic,1> m_sluRscale, m_sluCscale;
    mutable Matrix<RealScalar,Dynamic,1> m_sluFerr, m_sluBerr;
    mutable equed_t m_sluEqued;
...
void SuperLU<MatrixType>::factorize(const MatrixType& a)
{
  ...
  StatInit(0,0,&m_sluStat);

  // Notes:
  // Factorize pdgstrf
  // Triangular solve dgstrs
  //Simple Double Expert Driver Algorithm (pdgssv)
  //Parallel Double Expert Driver Algorithm (pdgssvx)

  /*SuperLU_MT
    pdgssvx(int_t nprocs, superlumt_options_t *superlumt_options, SuperMatrix *A, 
	int_t *perm_c, int_t *perm_r, 
...
//  m_sluOptions.IterRefine = NO; //NOREFINE
...
void SuperLUBase<MatrixType,Derived>::extractData() const
{
  ...
  if (m_extractedDataAreDirty)
  {
    ...
    int         lastl = 0, lastu = 0;
    SCPformat    *Lstore = static_cast<SCPformat*>(m_sluL.Store); //SC ~ SCP
    NCPformat    *Ustore = static_cast<NCPformat*>(m_sluU.Store);
    Scalar      *SNptr;
