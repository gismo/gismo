// .NAME GismoSource - generate polygonal geometry
// .SECTION Description
// GismoGeometrySource creates a geometry centered at a specified point and pointing in
...
#ifndef __GismoGeometrySource_h
#define __GismoGeometrySource_h
...
class VTKFILTERSSOURCES_EXPORT GismoGeometrySource : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(GismoGeometrySource,vtkPolyDataAlgorithm);
  ...
  // the x-axis.
  static GismoGeometrySource *New();
...
private:
  GismoGeometrySource(const GismoGeometrySource&);  // Not implemented.
  void operator=(const GismoGeometrySource&);  // Not implemented.
};
