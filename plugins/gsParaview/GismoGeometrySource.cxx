...
vtkStandardNewMacro(GismoGeometrySource);

//----------------------------------------------------------------------------
// Construct with default resolution 6, height 1.0, radius 0.5, and capping
// on.
GismoGeometrySource::GismoGeometrySource(int res)
{
  res = (res < 0 ? 0 : res);
  this->Resolution = res;
  this->Height = 1.0;
...
//----------------------------------------------------------------------------
int GismoGeometrySource::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  vtkDebugMacro("GismoGeometrySource Executing");
...
//----------------------------------------------------------------------------
int GismoGeometrySource::RequestInformation(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **vtkNotUsed(inputVector),
  vtkInformationVector *outputVector)
{
...
//----------------------------------------------------------------------------
void GismoGeometrySource::SetAngle(double angle)
{
  this->SetRadius( this->Height * tan( vtkMath::RadiansFromDegrees( angle ) ) );
}

//----------------------------------------------------------------------------
double GismoGeometrySource::GetAngle()
{
  return  vtkMath::DegreesFromRadians( atan2( this->Radius, this->Height ) );
}

//----------------------------------------------------------------------------
void GismoGeometrySource::PrintSelf(ostream& os, vtkIndent indent)
{
