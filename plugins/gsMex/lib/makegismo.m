...
if isunix
    ...
    definedMacros = ["EIGEN_MATRIXBASE_PLUGIN=<gsMatrix/gsMatrixAddons.h>" "EIGEN_PLAINOBJECTBASE_PLUGIN=<gsMatrix/gsPlainObjectBaseAddons.h>" "EIGEN_DEFAULT_DENSE_INDEX_TYPE=index_t" "EIGEN_DEFAULT_SPARSE_INDEX_TYPE=index_t" "EIGEN_DEFAULT_TO_COL_MAJOR" "EIGEN_NO_STATIC_ASSERT" "GISMO_BUILD_LIB"];
