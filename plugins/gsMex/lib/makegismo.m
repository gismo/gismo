...
if isunix
    ...
    definedMacros = ["EIGEN_MATRIXBASE_PLUGIN=<gsMatrix/gsMatrixAddons.h>" "EIGEN_PLAINOBJECTBASE_PLUGIN=<gsMatrix/gsPlainObjectBaseAddons.h>" "EIGEN_DEFAULT_DENSE_INDEX_TYPE=index_t" "EIGEN_DEFAULT_SPARSE_INDEX_TYPE=index_t" "EIGEN_DEFAULT_TO_COL_MAJOR" "EIGEN_NO_STATIC_ASSERT"];
    % "GISMO_BUILD_LIB" "_XOPEN_SOURCE"
    ...
    % fullfile(srcpath,"src/gsCore/gsForwardDeclarations.h"), ...
    % fullfile(srcpath,"src/gsUtils/gsThreaded.h"), ...
    % fullfile(srcpath,"src/gsCore/gsMath.h"), ...
    % fullfile(srcpath,"src/gsCore/gsFunction.h"), ... % NO Supported constructs
    % fullfile(srcpath,"src/gsUtils/gsPointGrid.h"), ...
    % fullfile(srcpath,"src/gsNurbs/gsBSpline.h"), ...
    % fullfile(srcpath,"src/gsNurbs/gsTensorBSplineBasis.h"), ...
    % fullfile(srcpath,"src/gsNurbs/gsTensorBSpline.h"), ...
    % fullfile(srcpath,"src/gsHSplines/gsHBSplineBasis.h"), ...
    % fullfile(srcpath,"src/gsNurbs/gsKnotVector.h"), ...
    % fullfile(srcpath,"src/gismo.h"), ...
    % fullfile(srcpath,"src/gsNurbs/gsBSplineBasis.h"), ...
